...
declare module androidui {
    ...
    class UKotNative {
        static initElement(ele: AndroidUIElement): AndroidUI;
    }
}
declare module androidui {
    import View = android.view.View;
    ...
    class AndroidUI {
        ...
        startLaunchActivity(intent: Intent): void;
...
declare module android.app {
    ...
    class Activity extends Context implements Window.Callback, KeyEvent.Callback {
        ...
        fakeOnCreate: (savedInstanceState?: Bundle) => void;
        fakeOnStart: () => void;
        fakeOnReStart: () => void;
        fakeResume: () => void;
        fakePause: () => void;
        fakeStop: () => void;
        fakeDestroy: () => void;
        onFakeOnCreate(foo?: (savedInstanceState?: Bundle) => void): void;
        onFakeOnStart(foo?: () => void): void;
        onFakeOnReStart(foo?: () => void): void;
        onFakeResume(foo?: () => void): void;
        onFakePause(foo?: () => void): void;
        onFakeStop(foo?: () => void): void;
        onFakeDestroy(foo?: () => void): void;
        getIntent(): Intent;
